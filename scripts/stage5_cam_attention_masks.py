...
def main():
    ...
    dataset = MultiChannelLeafDataset(manifest_df, config, split="train") # Process all train for now
    ...
    for batch_idx, batch in enumerate(tqdm(loader, desc="Stage 5 Fusion")):
